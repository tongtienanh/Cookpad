...
use Workable\Feed\Enum\FeedCType;
use Workable\Feed\Enum\FeedType;
...
class FeedRss
{
    ...
    public function render($format = null, $cache = null, $key = null)
    {
        ...
        if (null !== $this->ctype) {
            ...
            $ctype = ($format == FeedType::TYPE_ATOM) ? FeedCType::TYPE_ATOM : FeedCType::TYPE_RSS;
        };
        ...
        if (0 < $this->caching) {
            ...
            return $this->response->make(
                $this->cache->get($this->cacheKey), 200, [
            ...
            $this->clearCache();
            return $this->response->make(
                $this->view->make($view, $viewData), 200, [
     ...
     * @return string
     */
    public static function link($url, $type = FeedType::TYPE_ATOM, $title = null, $lang = null)
    {
        $type = (in_array($type, [FeedType::TYPE_RSS, FeedType::TYPE_ATOM], true)) ? 'application/' . $type . '+xml' : $type;
