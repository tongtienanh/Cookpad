...
class site_mapController extends Controller
{
    ...
    public function index(){
        ...
        return view('pages.site_map.index');
    }
    public function site_map_category(){
        return view('pages.site_map.site_map_category');
    }
}
