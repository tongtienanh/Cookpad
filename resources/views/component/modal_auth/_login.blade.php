<div class="box-popup-login modal">
    <div class="modal-header">
        <span class="modal-title">{{ __('static.box_auth.login.login_text') }}</span>
    </div>
    <div class="modal-body">
        <div class="page-auth">
            <form action="" method="post">
                ...
                <a href="#" rel="nofollow"
                   class="mt-2 text-bold btn btn-green-outline btn-p-1230 btn-block js-popup-forget-password">{{ __('static.box_auth.login.forgot_password') }}
                </a>
            </form>
            ...
            <div class="social-text">
                ...
                <div class="text-center text-sm mt10 text-login"> {{ __('static.box_auth.login.not_account') }}
                </div>
                <div class="social-login-container">
                    <a class="js-popup-register" rel="nofollow" data-gtm="start-auth"
                       href="#" >
