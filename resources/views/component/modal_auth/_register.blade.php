<div class="box-popup-register modal">
    <div class="modal-header">
        <span class="modal-title">{{ __('static.box_auth.register.register_text') }}</span>
    </div>
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    <input type="email" class="form-control form-control-md" name="email" value=""
                           placeholder="{{ __('static.box_auth.register.placeholder_account') }}">
                </div>
                <div class="form-group">
                    <input type="password" class="form-control form-control-md" name="password" value=""
                           placeholder="{{ __('static.box_auth.register.placeholder_password') }}">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control form-control-md" name="name" value=""
                           placeholder="{{ __('static.box_auth.register.placeholder_name') }}">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control form-control-md" name="phone" value=""
                           placeholder="{{ __('static.box_auth.register.placeholder_phone') }}">
                </div>
                <input type="hidden" name="callback" value="">
                <button type="submit" class="btn btn-green btn-p-1230 btn-not-radius btn-block js-iframe-login">
                    {{ __('static.box_auth.register.register') }}
                </button>
            </form>
            <div class="social-text">
                <p>{{ __('static.box_auth.des_auth') }} <a
                        href="{{ route('get.static.term_of_use') }}" target="_blank">{{ __('static.term_of_use') }}</a> {{ __('static.box_auth.and') }}
                    <a
                        href="{{ route('get.static.policy_info_security') }}" target="_blank">{{ __('static.policy_info_security') }}</a>
                </p>
            </div>
            <div class="social-text">
                <div class="social-hr">
                    <div class="hr"><span>{{ __('static.box_auth.register.or_more') }}</span></div>
                </div>
                <div class="social-login-container">
                    <a class="js-popup-login" rel="nofollow" data-gtm="start-auth"
                       href="#">
                        ...
                        <div class="heading-xsmall social-login-text">{{ __('static.box_auth.register.login') }}</div>
                    </a>
