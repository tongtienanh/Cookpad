...
{{--        @if (\Request::route()->getName() != 'review')--}}
...
{{--        @endif--}}
        ...
        @if (\Request::route()->getName() != 'detail'&&\Request::route()->getName() != 'post'&&\Request::route()->getName() != 'get.home.index'&&\Request::route()->getName() != 'get.search.submit'
&&\Request::route()->getName() != 'booking'&&\Request::route()->getName() != 'review_post'&&\Request::route()->getName() != 'profile')

        <div class="search-container">
            <label for="" style="color: #FFFFFF;display: flex">.
            <input class="search__input" type="text" placeholder="Hôm nay bạn muốn đi đâu,ăn gì?">
            </label>
        ...
        <div class="header-right-box">
            ...
            <ul class="menu-header">
                <li><a href="{{ route('post') }}" class="active"><i class="la la-plus-circle"></i> Đăng</a>
                <div class="post-dropdown">
                    <a href="{{route('post')}}" class="post-dropdown-item">Đăng công thức</a>
                    <a href="{{route('review_post')}}" class="post-dropdown-item">Đăng review</a>
                </div>
                </li>
                <li><a href="{{route('booking')}}" rel="nofollow">Đặt bàn</a></li>
                <li><a href="{{route('review')}}" rel="nofollow">Review</a></li>
                <li><a href="{{route('blog')}}" rel="nofollow">Blog</a></li>
