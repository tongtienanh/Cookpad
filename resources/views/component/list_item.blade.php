<div class="list-item" style="width: 100%; margin-top: 20px;">
    <div style="display: flex; margin-left: -15px;">
        <div class="hidden-mobile" style="box-sizing: border-box; background-clip: padding-box; width: 33%; border-width: 0px 0px 0px 15px; border-style: solid; border-color: transparent; border-image: initial;">
            @for($i=1;$i<12;$i++)
                <div data-link="{{route('get.review.detail')}}" class="card_rating">
                    <div id="" class="review-item">
                        ...
                        <div class="box-info">
                            ...
                            <a href="#" rel="nofollow" class="author d-flex align-items-center float-left">
                                ...
                                <h5 class="my-auto number-count text-truncate" style="font-size: 14px;">Trứng Cút</h5>
                            </a>
                            <div class="rating d-flex align-conent-center float-right hover hover-ic"><i class="fa fa-heart-o" aria-hidden="true"></i>
                                <span class="my-auto number-count">35</span>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                    ...
                    <div id="" class="review-item">
                        ...
                        <div class="box-info">
                            ...
                            <a href="/pnhphuc275" class="author d-flex align-items-center float-left">
                                ...
                                <h5 class="my-auto number-count text-truncate" style="font-size: 14px;">Phúc Hoàng</h5>
                            </a>
                            <div class="rating d-flex align-conent-center float-right hover hover-ic">
                                <i class="fa fa-heart-o" aria-hidden="true"></i>
                                <span class="my-auto number-count">1</span>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                    ...
                    <div id="" class="review-item">
                        ...
                        <div class="box-info">
                            ...
                            <a href="/heavenly" class="author d-flex align-items-center float-left">
                                ...
                                <h5 class="my-auto number-count text-truncate" style="font-size: 14px;">Heaven Ly</h5>
                            </a>
                            <div class="rating d-flex align-conent-center float-right hover hover-ic"><i class="fa fa-heart-o" aria-hidden="true"></i>
                                <span class="my-auto number-count">45
                        </span>
                            </div>
                            <div class="clearfix"></div>
                        </div>
