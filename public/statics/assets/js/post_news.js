...
/***/ "./resources/assets/js/pages/post_news.js":
/*!************************************************!*\
  !*** ./resources/assets/js/pages/post_news.js ***!
  \************************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function($) {var PostNews = {
  init: function init() {
    this.ShowCount();
    this.dropdownOption();
    this.addStep();
...
$(document).ready(function () {
      ...
      $(wrapper).append(' <div class="test">\n' + '                    <div class="group">\n' + '                        <i class="fa fa-arrows" aria-hidden="true"></i>\n' + '                        <div class="item">\n' + '                            <input class="js-tienanh about-form " type="text" placeholder="250 bột">\n' + '                        </div>\n' + '                        <i class="fa fa-times" aria-hidden="true"></i>\n' + '                    </div>\n' + '                    <div class="the-count" >\n' + '                        <span class="current">0</span>\n' + '                        <span class="maximum">/ 300</span>\n' + '                    </div>\n' + '                </div>').ready(function () {
        $(function () {
          $('.about-form').focus(function () {
            ...
            console.log(0); // $('.the-count:eq(' + n + ')').css('visibility', 'visible')
  ...
  $(add_button_part).click(function (e) {
    //on add input button click
    e.preventDefault();
...
$(document).on('change', ".file-upload-1", function () {
  ...
  var $elePreview = $parent.children('.image-holder-1');
  var $imageHere = $(this).closest('.image-here');
  $.ajax({
    type: "GET",
    url: "/upload",
    beforeSend: function beforeSend() {
    ...
    success: function success() {
      setTimeout(function () {
        if (typeof FileReader != "undefined") {
          ...
          image_holder.show();
          reader.readAsDataURL($(that)[0].files[0]);
          $(that).closest('.upload').find('.editor-step').css('visibility', 'visible'); // $(".editor-step").css('visibility','visible')
...
/***/ 3:
/*!******************************************************!*\
  !*** multi ./resources/assets/js/pages/post_news.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/cookpad_main-master/resources/assets/js/pages/post_news.js */"./resources/assets/js/pages/post_news.js");
