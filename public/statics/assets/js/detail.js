...
var Detail = {
  init: function init() {
    ...
    this.modalShow();
    this.modalImage();
    this.hidePopup(); // this.inputCommetn();
  },
  ...
  modalImage: function modalImage() {
...
var destroyPlugin = function destroyPlugin($elem, eventNamespace) {
...
module.exports = __webpack_require__(/*! /var/www/cookpad_main-master/resources/assets/js/pages/detail.js */"./resources/assets/js/pages/detail.js");
